...
public class Const {
	...
	public static final String SESSION_USER_AREA = "sessionUserArea";				//session用的区域负责人负责省份列表
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(plugins)|(static)|(main)|(websocket)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
