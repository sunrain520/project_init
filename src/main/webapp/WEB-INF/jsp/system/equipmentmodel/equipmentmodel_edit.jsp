		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="equipmentmodel/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="EQUIPMENTMODEL_ID" id="EQUIPMENTMODEL_ID" value="${pd.EQUIPMENTMODEL_ID}"/>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function hasU(){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>equipmentmodel/hasU.do',
